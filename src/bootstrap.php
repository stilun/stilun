...
function autoload($aClassName) 
{
	...
	$file1 = STILUN_SITE_PATH . $classFile;
	$file2 = STILUN_INSTALL_PATH . $classFile;
	if(is_file($file1)) 
	{
		require_once($file1);
	} 
...
{
	echo "Stilun: Uncaught exception: <p>" . $e->getMessage() . "</p><pre>" . $e->getTraceAsString(), "</pre>";
}
...
{
	return htmlentities($str, $flags, CStilun::Instance()->config['character_encoding']);
}

...
class CMGuestbook extends CObject implements IHasSQL, IModule 
{
	...
	*/
	public function Init() 
	{
		try 
		{
			...
			$this->session->AddMessage('notice', '<font color="green">Successfully created the database tables (or left them untouched if they already existed).</font>');
		} 
		catch(Exception$e) 
		{
	...
	*/
	public function Add($entry) 
	{
		...
		$this->session->AddMessage('success', '<font color="green">Successfully inserted new message.</font>');
	...
	*/
	public function DeleteAll() 
	{
		...
		$this->session->AddMessage('info', '<font color="red">Removed all messages from the database table.</font>');
	}

<?php
/**
* A model for managing Stilun modules.
*
* @package StilunCore
*/
class CMModules extends CObject
{
	...
	* Properties
	*/
	private $stilunCoreModules = array('CStilun', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
	private $stilunCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
   ...
   */
   private function GetDetailsOfModule($module) 
   {
   	   ...
   	   if(class_exists($module)) 
   	   {
   	   	   ...
   	   	   $details['isStilunCore'] = in_array($rc->name, $this->stilunCoreModules);
   	   	   $details['isStilunCMF'] = in_array($rc->name, $this->stilunCMFModules);

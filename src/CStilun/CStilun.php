<?php
/**
* Main class for Stilun, holds everything.
*
* @package StilunCore
*/
class CStilun implements ISingleton 
{
        ...
        protected function __construct() 
        {
                ...
                require(STILUN_SITE_PATH.'/config.php');
         ...
         * @return CStilun The instance of this class.
         */
        public static function Instance() 
        {
                if(self::$instance == null) 
                {
                        self::$instance = new CStilun();
                }
         ...
         */
         public function ThemeEngineRender() 
         {
         	 ...
         	 $themePath         = STILUN_INSTALL_PATH . '/' . $this->config['theme']['path'];
         	 ...
         	 {
         	 	 $parentPath = STILUN_INSTALL_PATH . '/' . $this->config['theme']['parent'];
         	 ...
         	 if(is_array($this->config['theme']['menu_to_region'])) 
         	 {
        	 	...
        	 	$ly = &$this;
        	 	// First the default Stilun themes/functions.php
        	 	include(STILUN_INSTALL_PATH . '/themes/functions.php');

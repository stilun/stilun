...
* Set database(s).
*/
$ly->config['database'][0]['dsn'] = 'sqlite:' . STILUN_SITE_PATH . '/data/.ht.sqlite';
...
* Template files can reside in the parent or current theme, the CStilun::ThemeEngineRender()
